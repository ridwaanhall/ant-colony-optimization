...
class AntColonyOptimization:
    def __init__(self, distance_matrix: np.ndarray, num_ants: int, num_iterations: int, alpha: float, beta: float, evaporation_rate: float, pheromone_constant: float):
...
aco = AntColonyOptimization(distance_matrix, num_ants, num_iterations, alpha, beta, evaporation_rate, pheromone_constant)
